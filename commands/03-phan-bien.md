...
(`/agent-writing-studio:02-viet-nhap <slug>`). Bài từ ngoài đưa vào mà chưa có `sentences.json`: sinh
...
Chấm xong thì dừng. **Không tự sửa bài** — sửa là việc của `/agent-writing-studio:04-bien-tap`, và trục
